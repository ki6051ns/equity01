...
使用方法:
    python scripts/preview_parquet.py <parquet_file_path> [--rows N] [--columns COL1,COL2,...]
    
例:
    python scripts/preview_parquet.py data/processed/index_tpx_daily.parquet
    python scripts/preview_parquet.py data/processed/paper_trade_with_alpha_beta.parquet --rows 20
    python scripts/preview_parquet.py data/processed/paper_trade_with_alpha_beta.parquet --columns trade_date,port_ret_cc,alpha_ret_cc
"""
import argparse
import sys
