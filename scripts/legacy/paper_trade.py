...
from tools.lib import data_loader  # 既存の load_prices を利用

# プロジェクトルートをパスに追加（config を読むため）
ROOT_DIR = Path(__file__).resolve().parents[2]  # scripts/legacy/ -> scripts/ -> equity01/
